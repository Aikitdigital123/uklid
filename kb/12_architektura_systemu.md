...
**Aktuální stav po refaktoru:** viz **kb/00_ARCHITEKTURA_PROJEKTU.md** (struktura, init flow, page dispatch, pravidla). Tento dokument zachycuje podrobnější vrstvy a toky dat; při rozporu s 00 ber v úvahu 00 jako zdroj pravdy.
